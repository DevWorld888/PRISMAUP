...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      name: "Kevin McEwen",
      avatar:
        "https://lh3.googleusercontent.com/a/ACg8ocKroJkHhumuRB1UE-E1VtAzfwlpvjA-L3VpYePheB2k8uKK4w=w90-h90-p-rp-mo-br100",
      rating: 5,
    },
    {
      ...
      avatar:
        "https://lh3.googleusercontent.com/a/ACg8ocIyxPQM-X2s-vdRhWuBItP5nhwE2oLU8OkVdtkCKUrXlKZfKQ=w90-h90-p-rp-mo-ba2-br100",
      name: "Joseph Haddad",
      rating: 5,
    },
    {
      ...
      name: "Matt Schaudin",
      avatar:
        "https://lh3.googleusercontent.com/a/ACg8ocIlC5LWV6cW6VNklQoOJByfdQWDRs4UcAQ4jH67Q-1IDILjew=w90-h90-p-rp-mo-br100",
      rating: 5,
    },
    {
      ...
      avatar:
        "https://lh3.googleusercontent.com/a/ACg8ocI2X9cKA-gMqHQToesKf9nVsh0DewPjrjeozsenWiE8wUwrYg=s45-c-rp-mo-br100",
      rating: 5,
    },
    {
      ...
      name: "Mateo Patino",
      avatar:
        "https://lh3.googleusercontent.com/a/ACg8ocKt0X65FUf5E4-wp6qV-ovRocQm53yBbnKZqqenT632qLigwg=w90-h90-p-rp-mo-br100",
      rating: 5,
    },
    {
      ...
      avatar:
        "https://lh3.googleusercontent.com/a-/ALV-UjUofxOQEbjNny-UKXyctGO-ixZ8bMjm6cUXkTsKnyEPhwq-Gy0=w90-h90-p-rp-mo-br100",
      rating: 5,
    },
    {
      ...
      name: "Lara Wilson",
      avatar:
        "https://lh3.googleusercontent.com/a/ACg8ocIjbHCOwAdQlV_q8yEOGxHfO4Z_6OhZ8rdYz6fVqv6AqSU4tg=w90-h90-p-rp-mo-br100",
      rating: 5,
    },
    {
      ...
      avatar:
        "https://lh3.googleusercontent.com/a/ACg8ocKJqAxouQLO099FSQmoRiyVh49WXeI6AHXvsmKZd8WekG6xrg=w90-h90-p-rp-mo-br100",
      rating: 5,
    },
    {
      ...
      name: "Chris",
      avatar:
        "https://lh3.googleusercontent.com/a-/ALV-UjVvr3ehQFsCqzcWFhN2qRfpSNbzTV5VyVv_i_KRVUTkBQvrylxzWQ=w90-h90-p-rp-mo-ba3-br100",
      rating: 5,
    },
  ];
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <span className="text-lg font-medium text-gray-700">
                    ⭐ Rated 5.0 on Google by Sydney homeowners & businesses
                  </span>
                </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="absolute top-8 right-8 z-10">
                  <svg
                    className="w-16 h-16 text-[#D61C1C]"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
          ...
          <div className="mt-16 text-center">
            <Link
              href="/contact"
              className="inline-block bg-[#D61C1C] hover:bg-red-600 text-white font-semibold text-lg px-8 py-4 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all"
            >
            ...
            <p className="mt-4 text-[#4A5568] text-sm">
              ...
              and speak with a painting expert
            </p>
          </div>
        </div>
      </section>
