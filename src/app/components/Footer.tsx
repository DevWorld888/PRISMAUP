          ...
          <div className="flex justify-center md:justify-start">
            <div className="text-center md:text-left">
              ...
              <p className="mt-4 text-sm text-gray-300 max-w-xs mx-auto md:mx-0">
                Professional painting and coating services in Sydney. Quality
                workmanship, competitive prices, and exceptional customer
                service.
              </p>
            </div>
          </div>
          ...
          <div className="text-center md:text-left">
            ...
            <address className="space-y-4 not-italic">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-300">
                  20/25 Marlowe St, Campsie, NSW 2193, Australia
                </p>
              </div>
            </address>
          </div>
