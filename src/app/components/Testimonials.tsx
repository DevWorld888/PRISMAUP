...
const Testimonials = () => {
  ...
  return (
    <>
      ...
      />
      <section className="py-20 bg-gray-50" aria-label="Customer testimonials and reviews">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <h2 className="text-5xl sm:text-6xl font-bold text-[#13233A] leading-tight" itemProp="headline">
                Customer Reviews for <br />
                <span className="text-[#D61C1C]">Prisma Coatings</span>
              </h2>

              <div className="border-l-4 border-[#D61C1C] pl-6" itemScope itemType="https://schema.org/AggregateRating">
                <div className="flex items-center space-x-3 mb-3">
                  <span className="text-5xl font-bold text-[#13233A]" itemProp="ratingValue">5.0</span>
                  <div className="flex items-center space-x-2">
                    <div className="flex space-x-1" role="img" aria-label="5 out of 5 stars">
                      {[...Array(5)].map((_, i) => (
                        <svg
                          key={i}
                ...
                {/* Google Rating Section - Added Highlighted Section */}
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <span className="text-lg font-medium text-gray-700">⭐ Rated 5.0 on Google by Sydney homeowners & businesses</span>
                </div>
                ...
                <p className="text-gray-700 font-medium text-lg">
                  Our clients rate us as the best painting contractors in the area. Professional house painting services with 5-star reviews.
            ...
            <div className="relative">
              <article className="bg-white rounded-3xl shadow-xl p-10 relative min-h-[400px]" itemScope itemType="https://schema.org/Review">
                {/* Quote Icon - Positioned to not overlap text */}
                <div className="absolute top-8 right-8 z-10">
                  <svg className="w-16 h-16 text-[#D61C1C]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="space-y-8 relative z-20 pr-20">
                  <blockquote className="text-gray-700 text-xl leading-relaxed italic font-light" itemProp="reviewBody">
                    &ldquo;{testimonials[currentTestimonial].text}&rdquo;
                  </blockquote>

                  {/* Customer Info */}
                  <div className="flex items-center space-x-5" itemProp="author" itemScope itemType="https://schema.org/Person">
                    <div className="w-16 h-16 bg-gray-300 rounded-full flex items-center justify-center overflow-hidden flex-shrink-0">
                      <Image
                        src={testimonials[currentTestimonial].avatar}
                        alt={`Customer photo of ${testimonials[currentTestimonial].name}, satisfied Prisma Coatings client`}
                        width={64}
                        height={64}
                    ...
                    <div className="flex-1 min-w-0">
                      {/* Star Rating */}
                      <div className="flex space-x-1 mb-2" itemProp="reviewRating" itemScope itemType="https://schema.org/Rating" role="img" aria-label={`${testimonials[currentTestimonial].rating} out of 5 stars`}>
                        <meta itemProp="ratingValue" content={testimonials[currentTestimonial].rating.toString()} />
                        <meta itemProp="bestRating" content="5" />
                        <meta itemProp="worstRating" content="1" />
                        {[...Array(testimonials[currentTestimonial].rating)].map((_, i) => (
                          <svg key={i} className="w-6 h-6 text-yellow-400 fill-current" viewBox="0 0 20 20" aria-hidden="true">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                          </svg>
                        ))}
                      </div>
                      <h4 className="font-semibold text-gray-900 text-lg" itemProp="name">
