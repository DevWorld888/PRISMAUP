...
const ContactPage = () => {
  ...
  const message =
    "¡Hi! I am interested in learning more about your painting services.";
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white">
              <h1 className="text-3xl font-bold text-[#13233A] mb-2 border-b-4 border-[#D61C1C] inline-block pb-1">
                Send a Message
              </h1>
              ...
              <div className="mt-4 text-center text-gray-600 text-sm">
                <p className="font-medium">
                  Free Quote – No Obligation – Reply Within 24h
                </p>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-blue-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                We will help you with all your painting and renovation
                questions.
              </p>
              <button
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">
                    <a href="tel:0401508036">Phone: 0401508036</a>
                  </span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">
                    <a href="mailto:info@prismacoatings.com.au">
