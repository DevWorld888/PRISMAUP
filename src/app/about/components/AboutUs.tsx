          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Established in 2015, Prisma Coatings has become one of Sydney&apos;s
              ...
              <p className="text-gray-600 leading-relaxed">
                Whether you need <strong>interior house painting</strong>,{" "}
                <strong>exterior home painting</strong>,
                <strong>office painting</strong>, or{" "}
                <strong>apartment complex painting</strong>, our skilled team
                delivers exceptional results on time and within budget. We serve
                all Sydney areas including Inner West, Eastern Suburbs, Northern
                Beaches, North Shore, and Western Sydney.
              </p>

              <div className="pt-4">
                <Link
                  href="/contact"
                  className="inline-block bg-[#D61C1C] hover:bg-[#C62828] text-white font-semibold px-8 py-4 rounded-lg transition-colors duration-300 shadow-lg hover:shadow-xl"
                >
